...
- **Strategy** Logic: The initial strategy implementation (logic) contract. See [here]((https://github.com/llamaxyz/llama/README.md#Deployments)) for a list of deployed strategy logic contracts, and [here](./strategy-comparison.md) learn about their differences.
