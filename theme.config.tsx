...
const config: DocsThemeConfig = {
  ...
  logo: (
    <>
      ...
      <span style={{ marginLeft: ".4em", fontWeight: 800 }}>Llama</span>
    </>
  ),
  project: {
